            ...
            <body>
                <div class="card">
                    ...
                    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                        <input type="submit" name="generar" value="Generar Clave" class="btn btn-primary">
                        <br>
                        <?php if (!empty($claveGenerada)) : ?>
                            ...
                            <br>
                            <button type="submit" name="guardar" value="<?php echo $claveGenerada; ?>" class="btn btn-success">Guardar Clave</button>
                            <button type="submit" name="noGuardar" value="" class="btn btn-danger">No Guardar Clave</button>
                        <?php endif; ?>
